	   ...
	   <div class="container-fluid mtop50p mbot50p">
		...
		<div class="row">
		 ...
		 <div class="col-md-12 col-sm-12 col-xs-12  mtop15p mbot15p fs22p">
		    <ul>
			  ...
			  <li>In order to facilitate the adjudication service, parent/guardian (in case of minor) needs
				to fill the Claimant Form.</li>
			  <li>We also provide offline record of achievements annually</li>
			  <li>No misuse of the company logo or any private information of the company. Action
		...
		<div class="row">
		 <div class="col-md-12 col-sm-12 col-xs-12 mtop50p">
		  ...
		  <div class="list-group-item fs22p">
			<b>Note:</b> If you wish to invite the judges or co coordinators fees, accommodation and travel expenses 
			should be taken care of. There should be an approval of chief coordinator of India to get a record 
			from Royal book of records.
		  </div><!--/.list-group-item -->
		  </div><!--/.list-group -->
		  <!-- -->
		</div><!--/.col-md-12 col-sm-12 col-xs-12 -->
