...
function viewLatestNews(){
 ...
 { action : 'VIEW_LATEST_NEWS' },function(response){
   ...
   for(var index=0;index<response.length;index++){
	...
	content+='<a href="'+PROJECT_URL+'manage-admin-gallery-desc/'+news_Id+'">';
	}
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><b>Add Latest Gallery</b></h4>
      </div>
...
function uploadMediaForm(){ 
 pictureUpload('add_latestNews_pic',{ folderName: 'gallery' },
		  ...
		  <div class="row">
		    <div class="col-xs-12 col-md-12 col-sm-12">
			  ...
			  <div class="form-group">
				...
				<div id="add_latestNews_desc" class="summernote">Write your <b>Description</b> here</div>
			  </div>
			  <!-- -->
			  
			  <!-- -->
			  <div class="form-group">
			    <button class="btn btn-primary form-control" onclick="javascript:addLatestNews();"><b>Add Latest Gallery</b></button>
			  </div>
			  <!-- -->
...
<div id="wrapper" class="toggled">
	...
	<div id="page-content-wrapper">
	   ...
	   <?php include_once 'templates/manage-gallery-page1.php'; ?>
